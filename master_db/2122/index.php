        ...
        <h3 class="section_heading">Membership Breakdown By Municipality - based on 5 year census</h3>
            ...
            <table id="fancy_table_2" class="special_table">
                <tr class="table_header">
                    ...
                    <th class="table_col">% of Membership</th>
                ...
                <tr class="table_row">
                    ...
                    <td class="table_col" id="csl_pct"></td>
                    <td class="table_col">2021-2022 Contribution $43,000</td>
                ...
                <tr class="table_row">
                    ...
                    <td class="table_col" id="got_pct"></td>
                    <td class="table_col">2021-2022 Contribution $20,603</td>
                ...
                <tr class="table_row">
                    ...
                    <td class="table_col" id="lt_pct"></td>
                    <td class="table_col">2021-2022 Contribution $25,000</td>
                ...
                <tr class="table_row">
                    ...
                    <td class="table_col"></td>
                    <td class="table_col">$88,603.00</td>
                    <td class="table_col"></td>
                </tr>
            </table>
...
<div id="generate_report">
   ...
   <script>
    ...
    function generateReport(){
        ...
        console.log(gt, csl, got, lt, oth);

        var agg_total = gt - oth;

        var csl_pct = (csl / agg_total) * 100;
        var got_pct = (got / agg_total) * 100;
        var lt_pct = (lt / agg_total) * 100;

        $("#csl_pct").text(csl_pct.toFixed(2) + "%");
        $("#got_pct").text(got_pct.toFixed(2) + "%");
        $("#lt_pct").text(lt_pct.toFixed(2) + "%");
    }
