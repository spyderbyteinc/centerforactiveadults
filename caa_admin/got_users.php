...
<main id="content">
    ...
    <!-- <ul id="nav_tabs">
            <li class="nav_item active"><a href="#" id="module1" name="all_members" class="nav_link">All Members</a></li>
...
<script>
    ...
    function filter_it(mythis, table, id_cont){
        var all_ids = [];

        var filter_val = mythis.value.toLowerCase();
    ...
    $('#filter').on("input", function() {
        var ids = filter_it(this, "all_user_table", "all_id");
