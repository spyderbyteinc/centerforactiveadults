...
<script>
    $(document).ready(function(){
            ...
            function flatten(tree){
                ...
                for(var c =0; c<columns.length; c++){
                    ...
                    if(normal.includes(key)){
                        ...
                        var wallet = branch['wallet'];
                        var ticket = branch['ticket'];
        ...
        function calculate_column(branch, type){
            console.log(branch);

            var leaf = branch[type];

            var total = 0;
            for(var l=0; l<leaf.length; l++){
                var item = leaf[l];
                var grabber = "#input_" + item;
            }
        ...
        for(var c = 0; c<1; c++){
            ...
            // normal column
            if(normal.includes(col)){
                calculate_column(branch, "cash");
            }
        }
    });
</script>
    ...
    <div id="table_container" class='table_sticky_container'>
        <table class="fancy_table" style="width: 100%;" id="deposit_table">
            ...
            <tr class="table_row membership_group">
                ...
                <td class="table_col" id="membership_fee_wallet"><input type="number" id="input_membership_fee_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="membership_fee_wallet"></td>
                <td class="table_col" id="membership_fee_ticket"><input type="number" id="input_membership_fee_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="membership_fee_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row membership_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="fob_replacement_wallet"><input type="number" id="input_fob_replacement_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="fob_replacement_wallet"></td>
                <td class="table_col" id="fob_replacement_ticket"><input type="number" id="input_fob_replacement_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="fob_replacement_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row main_group">
                <td class="table_col"></td>
                ...
                <td class="table_col wallet_total" id="membership_wallet_total">0</td>
                <td class="table_col ticket_total" id="membership_ticket_total">0</td>
            ...
            <tr class="table_row main_group travel_fees_group">
                ...
                <td class="table_col wallet_total_special" id="travel_fees_wallet"><input type="number" id="input_travel_fees_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="travel_fees_wallet"></td>
                <td class="table_col ticket_total_special" id="travel_fees_ticket"><input type="number" id="input_travel_fees_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="travel_fees_ticket"></td>
            ...
            <tr class="table_row class_fees_group">
                ...
                <td class="table_col" id="ageless_strength_wallet"><input type="number" id="input_ageless_strength_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="ageless_strength_wallet"></td>
                <td class="table_col" id="ageless_strength_ticket"><input type="number" id="input_ageless_strength_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="ageless_strength_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="anyone_can_paint_wallet"><input type="number" id="input_anyone_can_paint_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="anyone_can_paint_wallet"></td>
                <td class="table_col" id="anyone_can_paint_ticket"><input type="number" id="input_anyone_can_paint_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="anyone_can_paint_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="card_making_wallet"><input type="number" id="input_card_making_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="card_making_wallet"></td>
                <td class="table_col" id="card_making_ticket"><input type="number" id="input_card_making_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="card_making_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="drawing_with_lori_wallet"><input type="number" id="input_drawing_with_lori_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="drawing_with_lori_wallet"></td>
                <td class="table_col" id="drawing_with_lori_ticket"><input type="number" id="input_drawing_with_lori_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="drawing_with_lori_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="exercise_with_carol_wallet"><input type="number" id="input_exercise_with_carol_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="exercise_with_carol_wallet"></td>
                <td class="table_col" id="exercise_with_carol_ticket"><input type="number" id="input_exercise_with_carol_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="exercise_with_carol_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="fitness_with_gail_wallet"><input type="number" id="input_fitness_with_gail_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="fitness_with_gail_wallet"></td>
                <td class="table_col" id="fitness_with_gail_ticket"><input type="number" id="input_fitness_with_gail_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="fitness_with_gail_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="knit_crochet_wallet"><input type="number" id="input_knit_crochet_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="knit_crochet_wallet"></td>
                <td class="table_col" id="knit_crochet_ticket"><input type="number" id="input_knit_crochet_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="knit_crochet_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="line_dancing_wallet"><input type="number" id="input_line_dancing_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="line_dancing_wallet"></td>
                <td class="table_col" id="line_dancing_ticket"><input type="number" id="input_line_dancing_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="line_dancing_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="pilates_wallet"><input type="number" id="input_pilates_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="pilates_wallet"></td>
                <td class="table_col" id="pilates_ticket"><input type="number" id="input_pilates_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="pilates_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="wallet_wallet"><input type="number" id="input_wallet_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="wallet_wallet"></td>
                <td class="table_col" id="wallet_ticket"><input type="number" id="input_wallet_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="wallet_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="watercolor_wallet"><input type="number" id="input_watercolor_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="watercolor_wallet"></td>
                <td class="table_col" id="watercolor_ticket"><input type="number" id="input_watercolor_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="watercolor_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row class_fees_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="yoga_wallet"><input type="number" id="input_yoga_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="yoga_wallet"></td>
                <td class="table_col" id="yoga_ticket"><input type="number" id="input_yoga_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="yoga_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row main_group">
                <td class="table_col"></td>
                ...
                <td class="table_col wallet_total" id="class_fees_check_wallet">0</td>
                <td class="table_col ticket_total" id="class_fees_check_ticket">0</td>
            ...
            <tr class="table_row main_group swim_group">
                ...
                <td class="table_col wallet_total_special" id="swimming_wallet"><input type="number" id="input_swimming_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="swimming_wallet"></td>
                <td class="table_col ticket_total_special" id="swimming_ticket"><input type="number" id="input_swimming_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="swimming_ticket"></td>
            ...
            <tr class="table_row fund_raising_group">
                ...
                <td class="table_col" id="closet_wallet"><input type="number" id="input_closet_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="closet_wallet"></td>
                <td class="table_col" id="closet_ticket"><input type="number" id="input_closet_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="closet_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="coffee_wallet"><input type="number" id="input_coffee_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="coffee_wallet"></td>
                <td class="table_col" id="coffee_ticket"><input type="number" id="input_coffee_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="coffee_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="events_wallet"><input type="number" id="input_events_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="events_wallet"></td>
                <td class="table_col" id="events_ticket"><input type="number" id="input_events_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="events_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="kroger_wallet"><input type="number" id="input_kroger_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="kroger_wallet"></td>
                <td class="table_col" id="kroger_ticket"><input type="number" id="input_kroger_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="kroger_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="library_wallet"><input type="number" id="input_library_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="library_wallet"></td>
                <td class="table_col" id="library_ticket"><input type="number" id="input_library_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="library_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="quick_lunch_wallet"><input type="number" id="input_quick_lunch_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="quick_lunch_wallet"></td>
                <td class="table_col" id="quick_lunch_ticket"><input type="number" id="input_quick_lunch_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="quick_lunch_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="sponsorship_wallet"><input type="number" id="input_sponsorship_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="sponsorship_wallet"></td>
                <td class="table_col" id="sponsorship_ticket"><input type="number" id="input_sponsorship_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="sponsorship_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row fund_raising_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="water_wallet"><input type="number" id="input_water_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="water_wallet"></td>
                <td class="table_col" id="water_ticket"><input type="number" id="input_water_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="water_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row main_group">
                <td class="table_col"></td>
                ...
                <td class="table_col wallet_total" id="fund_raising_wallet_total">0</td>
                <td class="table_col ticket_total" id="fund_raising_ticket_total">0</td>
            ...
            <tr class="table_row donation_group">
                ...
                <td class="table_col" id="aarp_wallet"><input type="number" id="input_aarp_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="aarp_wallet"></td>
                <td class="table_col" id="aarp_ticket"><input type="number" id="input_aarp_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="aarp_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row donation_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="angels_wallet"><input type="number" id="input_angels_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="angels_check"></td>
                <td class="table_col" id="angels_ticket"><input type="number" id="input_angels_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="angels_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row donation_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="medical_loan_wallet"><input type="number" id="input_medical_loan_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="medical_loan_wallet"></td>
                <td class="table_col" id="medical_loan_ticket"><input type="number" id="input_medical_loan_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="medical_loan_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row donation_group">
                <td class="table_col"></td>
                ...
                <td class="table_col" id="miscellaneous_wallet"><input type="number" id="input_miscellaneous_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="miscellaneous_wallet"></td>
                <td class="table_col" id="miscellaneous_ticket"><input type="number" id="input_miscellaneous_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="miscellaneous_ticket"></td>
                <td class="table_col"></td>
            </tr>
            <tr class="table_row main_group">
                <td class="table_col"></td>
                ...
                <td class="table_col wallet_total" id="donation_total_wallet">0</td>
                <td class="table_col ticket_total" id="donation_total_ticket">0</td>
            ...
            <tr class="table_row main_group court_fees_group">
                ...
                <td class="table_col wallet_total_special" id="court_fees_wallet"><input type="number" id="input_court_fees_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="court_fees_wallet"></td>
                <td class="table_col ticket_total_special" id="court_fees_ticket"><input type="number" id="input_court_fees_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="court_fees_ticket"></td>
            ...
            <tr class="table_row main_group other_group">
                ...
                <td class="table_col wallet_total_special" id="other_wallet"><input type="number" id="input_other_wallet" placeholder="0" class="my_deposit_field" height="0" width="0" name="other_wallet"></td>
                <td class="table_col ticket_total_special" id="other_ticket"><input type="number" id="input_other_ticket" placeholder="0" class="my_deposit_field" height="0" width="0" name="other_ticket"></td>
            ...
            <tr class="table_row empty_row main_group">
                ...
                <td class="table_col">Wallet Total</td>
                <td class="table_col">Ticket Total</td>
            ...
            <tr class="table_row empty_row">
                ...
                <td class="table_col wallet_total" id="wallet_total">0</td>
                <td class="table_col ticket_total" id="ticket_total">0</td>
